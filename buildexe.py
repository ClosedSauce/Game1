...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "The Snake"
 
        #Project url
        self.project_url = "https://github.com/ClosedSauce"
 
        #Version of program
        self.project_version = "0.0.1"
 
        #License of the program
        self.license = "CloseSauce Licence"
 
        #Auhor of program
        self.author_name = "Jarkko Iso-Heiko / Teemu Petrelius"
        self.author_email = "jarkko@lauspalo.com"
        self.copyright = "Copyright (c) 2013 ClosedSauce"
 
        #Description
        self.project_description = "Simple Snake"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ["04B_03__.TTF"]
